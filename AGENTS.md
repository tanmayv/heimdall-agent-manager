...
| `Sidebar` | `nav-home-btn`, `nav-attention-btn`, `nav-settings-btn`, `sidebar-agent-launch-btn`, `sidebar-agent-picker`, `sidebar-agent-${agentId}`, `sidebar-chain-list`, `sidebar-chain-${chainId}`, `sidebar-new-chain-btn` |
