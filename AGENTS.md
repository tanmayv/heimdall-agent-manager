...
| `AgentsManagementSurface` | `agents-management-surface`, `agents-management-back-btn`, `agents-management-create-card`, `agents-management-create-identity-btn`, `agents-management-create-hint`, `agents-management-remote-create-card`, `agents-management-remote-peer-select`, `agents-management-remote-agent-id-input`, `agents-management-remote-local-agent-id-input`, `agents-management-remote-display-name-input`, `agents-management-remote-template-input`, `agents-management-remote-create-agent-id-btn`, `agents-management-remote-create-message`, `agents-management-remote-agent-picker`, `agents-management-list`, `agents-management-agent-${agentId}`, `agents-management-counts-${agentId}`, `agents-management-status-${agentId}`, `agents-management-summary-${agentId}`, `agents-management-edit-btn-${agentId}`, `agents-management-new-instance-btn-${agentId}` |
