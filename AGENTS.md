...
| `ProjectsSurface` | `projects-surface`, `projects-new-btn`, `projects-create-form`, `projects-create-name-input`, `projects-create-path-input`, `projects-create-error`, `projects-create-submit-btn`, `projects-create-cancel-btn`, `projects-search-input`, `projects-list`, `projects-empty`, `projects-row-${projectId}`, `project-detail`, `project-detail-back-btn`, `project-detail-title`, `project-detail-agents`, `project-detail-new-agent-btn`, `project-detail-agents-empty`, `project-detail-agent-${agentId}`, `project-detail-memory`, `project-detail-open-memory-btn`, `project-detail-memory-empty`, `project-detail-memory-${memoryId}`, `project-detail-bridge-paths`, `project-detail-bridge-path-row-${bridgeId}`, `project-detail-bridge-path-validate-${bridgeId}`, `project-detail-bridge-path-remove-${bridgeId}`, `project-detail-bridge-paths-empty`, `project-detail-bridge-path-device`, `project-detail-bridge-path-input`, `project-detail-bridge-path-save-btn`, `project-detail-bridge-path-error` |
