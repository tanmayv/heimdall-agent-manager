...
| `AgentDetailPage` | `agent-detail-page`, `agent-detail-back-btn`, `agent-detail-title`, `agent-detail-live-status`, `agent-detail-project`, `agent-detail-role`, `agent-detail-provider`, `agent-detail-runtime`, `agent-detail-chat`, `agent-detail-refresh-chat-btn`, `agent-detail-chat-input`, `agent-detail-nudge-btn`, `agent-detail-chat-send-btn`, `agent-detail-tasks`, `agent-detail-task-${taskId}`, `agent-detail-task-open-chain-${taskId}` |
