...
| `MemoryScopeSelector` | `${debugPrefix}-agent-select`, `${debugPrefix}-project-select`, `${debugPrefix}-bridge-select`, `${debugPrefix}-template-select`, `${debugPrefix}-instance-select`, `${debugPrefix}-type-select`, `${debugPrefix}-summary`; current prefixes include `memory-scope`, `memory-filter-scope`, `memory-proposal-scope-${memoryId}`, and `memory-edit-scope-${memoryId}` |
