...
| `Sidebar` | `nav-home-btn`, `nav-attention-btn`, `nav-settings-btn`, `sidebar-agent-launch-btn`, `sidebar-agent-picker`, `sidebar-agent-picker-close-btn`, `sidebar-agent-${agentId}`, `sidebar-agent-chat`, `sidebar-agent-chat-close-btn`, `sidebar-agent-chat-input`, `sidebar-agent-chat-send-btn`, `sidebar-chain-list`, `sidebar-chain-${chainId}`, `sidebar-new-chain-btn` |
