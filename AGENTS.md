...
| `AgentsManagementSurface` | `agents-management-surface`, `agents-management-back-btn`, `agents-management-create-card`, `agents-management-create-identity-btn`, `agents-management-create-hint`, `agents-management-list`, `agents-management-agent-${agentId}`, `agents-management-counts-${agentId}`, `agents-management-status-${agentId}`, `agents-management-summary-${agentId}`, `agents-management-edit-btn-${agentId}`, `agents-management-new-instance-btn-${agentId}` |
