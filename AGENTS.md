...
| `AgentsPanel` | `agents-add-agent-btn`, `agents-create-close-btn`, `agents-create-name-input`, `agents-create-template-select`, `agents-create-instructions-toggle-btn`, `agents-create-instructions-input`, `agents-create-bridge-scope`, `agents-create-provider-scope`, `agents-create-provider-select`, `agents-create-tier-select`, `agents-create-submit-btn`, `agents-create-cancel-btn`, `agents-no-capabilities-warning`, `agents-agent-row-${agentId}`, `agents-agent-open-btn-${agentId}`, `agents-agent-launch-btn-${agentId}`, `agents-agent-archive-btn-${agentId}` |
...
| `SettingsPage` | `settings-modal`, `settings-rail`, `settings-body`, `settings-close-btn`, `settings-single-daemon-note`, `settings-nav-${key}`, `settings-nav-defaults`, `settings-nav-daemon`, `settings-nav-providers`, `settings-default-agents-panel`, `settings-default-agents-refresh-btn`, `settings-default-agents-save-btn`, `settings-default-agent-use-${use}-row`, `settings-default-agent-use-${use}-picker-btn`, `settings-default-agent-use-${use}-value`, `settings-default-agents-save-message`, `settings-daemon-single-active-banner`, `settings-daemon-list`, `settings-daemon-row-${daemonKey}`, `settings-daemon-reconnect-btn-${daemonKey}`, `settings-daemon-remove-btn-${daemonKey}`, `settings-daemon-url-input`, `settings-daemon-label-input`, `settings-daemon-user-input`, `settings-daemon-add-btn`, `settings-peer-daemon-list`, `settings-peer-daemon-row-${peerKey}`, `settings-peer-daemon-reconnect-btn-${peerKey}`, `settings-peer-daemon-remove-btn-${peerKey}`, `settings-peer-daemon-url-input`, `settings-peer-daemon-label-input`, `settings-peer-daemon-token-input`, `settings-peer-daemon-connect-btn`, `settings-debug-server-checkbox`, `settings-providers-single-daemon-banner`, `settings-providers-daemon-select`, `settings-providers-list`, `settings-provider-card-${providerName}`, `settings-provider-default-btn-${providerName}`, `providers-bridge-select`, `providers-add-btn`, `providers-provider-row-${providerName}`, `providers-enabled-toggle-${providerName}`, `providers-edit-btn-${providerName}`, `providers-delete-btn-${providerName}`, `providers-test-btn-${providerName}`, `providers-test-result-${providerName}`, `providers-refresh-caps-btn`, `provider-source-badge-${providerName}`, `providers-editor-close-btn`, `providers-editor-name-input`, `providers-enabled-toggle-editor`, `providers-editor-command-input`, `providers-editor-command-chip-input`, `providers-editor-command-chip-add-btn`, `providers-editor-command-chip-${index}`, `providers-editor-command-chip-remove-btn-${index}`, `providers-editor-prompt-flags-chip-input`, `providers-editor-prompt-flags-chip-add-btn`, `providers-editor-prompt-flags-chip-${index}`, `providers-editor-prompt-flags-chip-remove-btn-${index}`, `providers-editor-yolo-flags-chip-input`, `providers-editor-yolo-flags-chip-add-btn`, `providers-editor-yolo-flags-chip-${index}`, `providers-editor-yolo-flags-chip-remove-btn-${index}`, `providers-editor-startup-blocked-patterns-chip-input`, `providers-editor-startup-blocked-patterns-chip-add-btn`, `providers-editor-startup-blocked-patterns-chip-${index}`, `providers-editor-startup-blocked-patterns-chip-remove-btn-${index}`, `providers-editor-startup-auto-enter-patterns-chip-input`, `providers-editor-startup-auto-enter-patterns-chip-add-btn`, `providers-editor-startup-auto-enter-patterns-chip-${index}`, `providers-editor-startup-auto-enter-patterns-chip-remove-btn-${index}`, `providers-editor-startup-auto-enter-pre-keys-chip-input`, `providers-editor-startup-reason-mapping-chip-input`, `providers-editor-startup-reason-mapping-reason-input`, `providers-editor-startup-reason-mapping-chip-add-btn`, `providers-editor-startup-reason-mapping-chip-${index}`, `providers-editor-startup-reason-mapping-chip-remove-btn-${index}`, `providers-editor-command-input`, `providers-editor-models-flag-input`, `providers-editor-models-cheap-input`, `providers-editor-models-normal-input`, `providers-editor-models-smart-input`, `providers-editor-prompt-flags-input`, `providers-editor-yolo-flags-input`, `providers-editor-prompt-delivery-input`, `providers-editor-starter-prompt-input`, `providers-editor-startup-enabled-checkbox`, `providers-editor-startup-unknown-blocked-checkbox`, `providers-editor-startup-probe-input`, `providers-editor-startup-capture-interval-input`, `providers-editor-startup-blocked-patterns-input`, `providers-editor-startup-auto-enter-patterns-input`, `providers-editor-startup-auto-enter-pre-keys-input`, `providers-editor-startup-reason-mapping-input`, `providers-editor-activity-enabled-checkbox`, `providers-editor-activity-sample-lines-input`, `providers-editor-activity-ignore-bottom-input`, `providers-editor-activity-check-interval-input`, `providers-editor-activity-min-gap-input`, `providers-editor-activity-max-gap-input`, `providers-editor-save-btn`, `providers-editor-cancel-btn`, `settings-default-agent-provider-select`, `settings-default-agent-tier-select`, `settings-default-agent-save-btn`, `settings-back-btn`, `settings-create-agent-btn`, `settings-create-agent-modal`, `settings-create-agent-name-input`, `settings-create-agent-template-select`, `settings-create-agent-provider-select`, `settings-create-agent-tier-select`, `settings-create-agent-cancel-btn`, `settings-create-agent-cancel-secondary-btn`, `settings-create-agent-submit-btn`, `settings-create-agent-error`, `settings-direct-chat-agent-select`, `settings-direct-chat-feed`, `settings-direct-chat-message-${messageId}`, `settings-direct-chat-message-actions-${messageId}`, `settings-direct-chat-message-copy-btn-${messageId}`, `settings-direct-chat-status-banner`, `settings-direct-chat-status-start-btn`, `settings-direct-chat-composer-shell`, `settings-direct-chat-input`, `settings-direct-chat-send-btn`, `settings-bridges-panel`, `settings-bridges-add-btn`, `settings-bridges-load-error`, `settings-bridges-error`, `settings-bridges-enroll-panel`, `settings-bridges-enroll-label`, `settings-bridges-enroll-cancel`, `settings-bridges-enroll-create`, `settings-bridges-enroll-result`, `settings-bridges-enroll-command`, `settings-bridges-enroll-copy-token`, `settings-bridges-enroll-done`, `settings-bridges-pending`, `settings-bridges-pending-${enrollmentId}`, `settings-bridges-pending-revoke-${enrollmentId}`, `settings-bridges-list`, `settings-bridges-empty`, `settings-bridge-row-${bridgeId}`, `settings-bridge-status-${bridgeId}`, `settings-bridge-rename-input-${bridgeId}`, `settings-bridge-ready-${bridgeId}`, `settings-bridge-status-label-${bridgeId}`, `settings-bridge-caps-${bridgeId}`, `settings-bridge-rename-save-${bridgeId}`, `settings-bridge-rename-cancel-${bridgeId}`, `settings-bridge-revoke-confirm-${bridgeId}`, `settings-bridge-revoke-cancel-${bridgeId}`, `settings-bridge-rename-btn-${bridgeId}`, `settings-bridge-revoke-btn-${bridgeId}`, `settings-bridges-gap-note` |
