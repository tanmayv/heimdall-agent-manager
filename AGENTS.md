...
| `MemoryManagementPage` | `memory-management-surface`, `memory-management-home-btn`, `memory-refresh-btn`, `memory-filters-reset-btn`, `memory-filter-agent-input`, `memory-filter-project-input`, `memory-filter-template-input`, `memory-filter-bridge-input`, `memory-filter-search-input`, `memory-filter-type-select`, `memory-filter-status-select`, `memory-filter-targeting-select`, `memory-filter-pending-active-checkbox`, `memory-form-title-input`, `memory-form-type-select`, `memory-form-agent-input`, `memory-form-project-input`, `memory-form-template-input`, `memory-form-bridge-input`, `memory-form-source-task-input`, `memory-form-body-textarea`, `memory-form-metadata-textarea`, `memory-form-reason-textarea`, `memory-form-evidence-textarea`, `memory-form-submit-btn` |
