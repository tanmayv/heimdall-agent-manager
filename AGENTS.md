...
| `AppShell` | `shell-breadcrumbs`, `shell-breadcrumb-crumb-${index}`, `shell-breadcrumb-link-${index}`, `settings-sub-nav`, `settings-sub-nav-bridges`, `settings-sub-nav-providers`, `settings-sub-nav-projects`, `settings-sub-nav-memory`, `settings-sub-nav-defaults` |
