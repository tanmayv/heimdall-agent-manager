...
| `AgentsPanel` | `agents-add-agent-btn`, `agents-create-name-input`, `agents-create-template-select`, `agents-create-instructions-toggle-btn`, `agents-create-instructions-input`, `agents-create-bridge-scope`, `agents-create-provider-scope`, `agents-create-provider-select`, `agents-create-tier-select`, `agents-create-submit-btn`, `agents-create-header-cancel-btn`, `agents-create-footer-cancel-btn`, `agents-no-capabilities-warning`, `agents-agent-row-${agentId}`, `agents-agent-open-btn-${agentId}`, `agents-agent-launch-btn-${agentId}`, `agents-agent-archive-btn-${agentId}` |
