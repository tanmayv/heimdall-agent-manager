...
def main() -> None:
    ...
    require("043_fig_projects.sql" in migrations_odin or "041_fig_projects.sql" in migrations_odin or "040_fig_projects.sql" in migrations_odin or "034_fig_projects.sql" in migrations_odin or "032_fig_projects.sql" in migrations_odin or "031_fig_projects.sql" in migrations_odin or "029_fig_projects.sql" in migrations_odin or "028_fig_projects.sql" in migrations_odin or "027_fig_projects.sql" in migrations_odin, "migrations.odin must register 043_fig_projects.sql")
