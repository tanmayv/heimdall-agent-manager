...
def main() -> None:
    ...
    require("034_fig_projects.sql" in migrations_odin or "032_fig_projects.sql" in migrations_odin or "031_fig_projects.sql" in migrations_odin or "029_fig_projects.sql" in migrations_odin or "028_fig_projects.sql" in migrations_odin or "027_fig_projects.sql" in migrations_odin, "migrations.odin must register 034_fig_projects.sql")
