...
def main():
    ...
    require('sender_agent_instance_id IS NULL OR sender_agent_instance_id != ?' in content_repo, "SQLite receiver_only filter must correctly allow user_to_agent messages (IS NULL)")
