...
def main() -> None:
    ...
    janitor_lines = JANITOR.read_text(encoding="utf-8").splitlines()
    tracker = TRACKER.read_text(encoding="utf-8")

    require("agent_runtime_tracker_apply_startup_timeout" in tracker, "tracker should own startup-timeout transition")
    require("agent_runtime_tracker_apply_heartbeat_timeout" in tracker, "tracker should own heartbeat-timeout transition")
