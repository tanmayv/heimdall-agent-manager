...
federation_agent_status_callback_json :: proc(idempotency_key, proxy_agent_instance_id, status, connection_state, current_task_id, reason: string, updated_unix_ms: i64) -> string {
...
federation_propagate_agent_status :: proc(local_agent_instance_id, reason: string) -> int {
	...
	for p in pendings {
		...
		payload := federation_agent_status_callback_json(idempotency_key, p.proxy_agent_instance_id, status, connection_state, current_task_id, reason, updated_unix_ms)
...
remote_proxy_status_apply :: proc(proxy_agent_instance_id, status, connection_state, current_task_id: string, updated_unix_ms: i64) -> (changed: bool, ok: bool) {
