...
agent_generated_instance_id :: proc(template_id, project_id: string) -> string {
	prefix := template_id; if prefix == "" do prefix = "agent"
	suffix := project_id; if suffix == "" do suffix = fmt.tprintf("%d", router_now_unix_ms())
