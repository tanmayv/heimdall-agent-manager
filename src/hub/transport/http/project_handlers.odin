...
write_project_json :: proc(b: ^strings.Builder, p: domain.Project) { strings.write_string(b, "{\"project_id\":\""); write_handler_json_string(b, string(p.project_id)); strings.write_string(b, "\",\"name\":\""); write_handler_json_string(b, p.name); strings.write_string(b, "\",\"slug\":\""); write_handler_json_string(b, p.slug); strings.write_string(b, "\",\"repo_url\":\""); write_handler_json_string(b, p.repo_url); strings.write_string(b, "\",\"vcs_kind\":\""); write_handler_json_string(b, p.vcs_kind); strings.write_string(b, "\",\"default_path\":\""); write_handler_json_string(b, p.default_path); strings.write_string(b, "\",\"updated_at\":\""); write_handler_json_string(b, p.updated_at); strings.write_string(b, "\"}") }
