...
Content_List_Agent_Inbox_Messages_Proc :: proc(ctx: rawptr, conversation_id: string, owner_user_id: domain.User_ID, unread_only: bool, receiver_only: bool, include_outgoing: bool, include_debug: bool, limit: int, cursor: string) -> ([]domain.Chat_Message, domain.Domain_Error)
...
content_list_agent_inbox_messages :: proc(r: ^Content_Repository, id: string, owner: domain.User_ID, unread_only, receiver_only, include_outgoing, include_debug: bool, limit: int, cursor: string) -> ([]domain.Chat_Message, domain.Domain_Error) { if r == nil || r.list_agent_inbox_messages == nil do return nil, domain.domain_error(.Internal_Error, "content repository is not configured"); return r.list_agent_inbox_messages(r.ctx, id, owner, unread_only, receiver_only, include_outgoing, include_debug, limit, cursor) }
