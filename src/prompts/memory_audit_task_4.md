# Memory Audit: Task 4 - Recommendations
...
## Ask for Reviewer
Evaluate the memory recommendations. Check that they follow memory guidelines and styling rules. Confirm that no invalid/redundant memories are proposed.

## Success Criteria for Reviewer
- Confirm quality, relevance, and formatting of memory proposals.
- Cast LGTM on the task once satisfied.
