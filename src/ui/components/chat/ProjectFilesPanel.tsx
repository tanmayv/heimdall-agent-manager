      ...
      <div className="flex items-center justify-between gap-2 border-b border-subtle px-3 py-2.5">
        <div className="flex min-w-0 items-center gap-2">
          ...
          <div className="min-w-0">
            <div data-debug-id={`${debugPrefix}-title`} className="text-[12px] font-semibold text-primary">Files</div>
            {rootAbs ? (
              <div className="truncate font-mono text-[10px] text-faint" title={`Project root: ${rootAbs}`}>root: {rootAbs}</div>
            ) : null}
