...
function ProjectCreateForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="framer-card-xl mx-auto max-w-4xl space-y-4 p-5">
      ...
      <textarea data-debug-id="create-project-description" value={form.description} onChange={(event) => setForm({ ...form, description: event.target.value })} placeholder="Optional description" className="framer-input min-h-24 w-full px-3 py-2 resize-y" />
...
function ProjectEditForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="mt-5 space-y-4">
      ...
      <textarea data-debug-id="detail-project-description" value={form.description} onChange={(event) => setForm({ ...form, description: event.target.value })} placeholder="Project description" className="framer-input min-h-24 w-full px-3 py-2 text-sm resize-y" />
      <div className="space-y-3">
        <div className="flex items-center justify-between">
