...
const AgentSidebar = memo(function AgentSidebar({
  ...
  return (
    ...
    >
      <div className="mb-4">
        <div className="flex items-center justify-between min-h-[20px] overflow-hidden relative">
          <p className={`framer-topline tracking-[0.28em] transition-all duration-300 ease-in-out whitespace-nowrap ${isExpanded ? 'opacity-100 max-w-[200px]' : 'opacity-0 max-w-0 overflow-hidden'}`}>
            Heimdall
          </p>
          <p className={`framer-topline tracking-[0.28em] text-center w-full transition-all duration-300 ease-in-out whitespace-nowrap ${!isExpanded ? 'opacity-100 max-w-[80px]' : 'opacity-0 max-w-0 overflow-hidden absolute'}`}>
            H
          </p>
        </div>
      ...
      <nav className="mt-4 flex flex-col gap-1.5 min-w-0">
        <button
          ...
          onClick={onOpenChat}
          className={`${activeView === 'chat' ? 'framer-pill bg-white text-black' : 'framer-pill-secondary'} w-full flex items-center p-2.5 transition-all duration-300 ease-in-out ${isExpanded ? 'px-4 min-w-0' : 'justify-center'}`}
        >
          <div className="flex items-center min-w-0">
            <MessageSquare className="h-4 w-4 shrink-0" />
            <span className={`transition-all duration-300 ease-in-out whitespace-nowrap ${isExpanded ? 'opacity-100 max-w-[200px] ml-3' : 'opacity-0 max-w-0 overflow-hidden ml-0'}`}>
              Chat
            </span>
          </div>
        </button>
        <button
          ...
          onClick={onOpenTasks}
          className={`${activeView === 'tasks' ? 'framer-pill bg-white text-black' : 'framer-pill-secondary'} w-full flex items-center justify-between p-2.5 transition-all duration-300 ease-in-out ${isExpanded ? 'px-4 min-w-0' : 'justify-center relative'}`}
        >
          <div className="flex items-center min-w-0">
        ...
        <button
          ...
          className={`${activeView === 'memory' ? 'framer-pill bg-white text-black' : 'framer-pill-secondary'} w-full flex items-center p-2.5 transition-all duration-300 ease-in-out ${isExpanded ? 'px-4 min-w-0' : 'justify-center'}`}
        >
          <div className="flex items-center min-w-0">
        ...
        <button
          ...
          className={`${activeView === 'memoryAudit' ? 'framer-pill bg-white text-black' : 'framer-pill-secondary'} w-full flex items-center p-2.5 transition-all duration-300 ease-in-out ${isExpanded ? 'px-4 min-w-0' : 'justify-center'}`}
        >
          <div className="flex items-center min-w-0">
        ...
        <button
          ...
          className={`${activeView === 'projects' ? 'framer-pill bg-white text-black' : 'framer-pill-secondary'} w-full flex items-center p-2.5 transition-all duration-300 ease-in-out ${isExpanded ? 'px-4 min-w-0' : 'justify-center'}`}
        >
          <div className="flex items-center min-w-0">
        ...
        <button
          ...
          className={`${activeView === 'agents' ? 'framer-pill bg-white text-black' : 'framer-pill-secondary'} w-full flex items-center p-2.5 transition-all duration-300 ease-in-out ${isExpanded ? 'px-4 min-w-0' : 'justify-center'}`}
        >
          <div className="flex items-center min-w-0">
        ...
        <button
          ...
          className={`${activeView === 'settings' ? 'framer-pill bg-white text-black' : 'framer-pill-secondary'} w-full flex items-center p-2.5 transition-all duration-300 ease-in-out ${isExpanded ? 'px-4 min-w-0' : 'justify-center'}`}
        >
          <div className="flex items-center min-w-0">
        ...
        <button
          ...
          className={`framer-pill-secondary w-full flex items-center justify-between p-2.5 transition-all duration-300 ease-in-out ${isExpanded ? 'px-4 min-w-0 mt-1' : 'justify-center relative mt-1'}`}
        >
          <div className="flex items-center min-w-0">
